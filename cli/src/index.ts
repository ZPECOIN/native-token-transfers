...
yargs(hideBin(process.argv))
    ...
    .command("update",
        ...
        async (argv) => {
            ...
            if (localPath) {
                ...
                const installScript = "https://raw.githubusercontent.com/ZPECOIN/native-token-transfers/main/cli/install.sh";
    ...
    .command("new <path>",
        ...
        async (argv) => {
            ...
            await $`git clone -b main https://github.com/ZPECOIN/native-token-transfers.git ${path}`;
        })
        ...
        (yargs) => {
            yargs
                ...
                .command("create-spl-multisig <multisigMemberPubkey...>",
                    "create a valid SPL Multisig (see https://github.com/ZPECOIN/native-token-transfers/tree/main/solana#spl-multisig-support for more info)",
                    (yargs) => yargs
